> *Google ADK을 이용하여 RAG 작성하였다. /doc 폴더에 저장한 pdf 파일을 참고하여, 파일 범위안에서 사용자의 질의에 답하는 에이전트이다.

> *실행 방법:  
> python rag_agent_chroma_adk.py --build : "PDF 임베딩 생성"  
> python rag_agent_chroma_adk.py --chat '질문 내용 입력' : "PDF 내용 관련 질문"

#### 실행 결과 "python rag_agent_chroma_adk.py --build"

![](https://velog.velcdn.com/images/wonterry/post/629b2010-18a1-4f3a-a0db-b688cfb81232/image.png)

#### 실행 결과 "rag_agent_chroma_adk.py --chat 'plan RAG 관련 내용 요약'"

![](https://velog.velcdn.com/images/wonterry/post/a510fa68-b12a-4f91-8d56-2a5abd33e8df/image.png)
